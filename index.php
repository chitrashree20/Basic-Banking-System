...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #82E0AA;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="/Banking/img/bank.png" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>CHITRASHREE P</b> <br> (Union bank : Basic Banking System) at Sparks Foundation GRIP21</p>
</footer>
